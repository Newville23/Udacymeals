...
class App extends Component {
  ...
  render() {
    const { foodModalOpen, loadingFood, food, openIngredientsModal } = this.state
    ...
    return (
      <div className="container">
        ...
        <Modal
          className='modal'
          overlayClassName='overlay'
          isOpen={openIngredientsModal}
          onRequestClose={this.closeIngredientsModal}
          contentLabel='Modal'
        >
          {openIngredientsModal && <ShoppingList list={this.generateShoppingList()} />}
        </Modal>
